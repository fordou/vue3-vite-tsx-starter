...
<script>
  ...
  export default {
    ...
    computed: {
      ...mapGetters({
        visitedRoutes: 'TAGS_BAR/visitedRoutes',
    ...
    methods: {
      ...mapActions({
        addVisitedRoute: 'TAGS_BAR/addVisitedRoute',
        delVisitedRoute: 'TAGS_BAR/delVisitedRoute',
        delOthersVisitedRoutes: 'TAGS_BAR/delOthersVisitedRoutes',
        delLeftVisitedRoutes: 'TAGS_BAR/delLeftVisitedRoutes',
        delRightVisitedRoutes: 'TAGS_BAR/delRightVisitedRoutes',
        delAllVisitedRoutes: 'TAGS_BAR/delAllVisitedRoutes',
      }),
